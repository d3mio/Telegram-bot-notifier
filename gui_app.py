"""
Telegram Alert Studio — Visual Bot Automation Workspace GUI
...
class ApplicationGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Telegram Alert Studio — Visual Bot Automation Workspace GUI")
        ...
        title_label = ttk.Label(header_frame, text="⚡ Telegram Alert Studio — Visual Bot Automation Workspace GUI", style="Header.TLabel")
        title_label.pack(anchor="w")
        
        sub_label = ttk.Label(header_frame, text="Desktop GUI managing Telegram bot webhooks, alert triggers, message templates, and subscriber stats.", foreground="#94A3B8")
